      ...
      <section className="choose-ue-area" style={{ padding: "30px 0" }}>
        <div className="container">
          <div className="d-flex row align-items-center justify-content-between flex-column flex-sm-row flex-wrap">
            <div className="col-lg-3 col-sm-6 fluid d-flex align-items-center group-wrap py-3 justify-content-center rounded">
            ...
            <div className="col-lg-3 col-sm-6 d-flex align-items-center group-wrap py-3 justify-content-center rounded">
              <div className="position-relative">
