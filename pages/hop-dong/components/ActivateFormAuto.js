            ...
            <Col span={24}>
                ...
                <Col xs={{ span: 24 }} md={{ span: 24 }}>
                    <Field type="text" name="license_number" title="Biển số xe" rules={[
                        ({ getFieldValue }) => ({
                            validator(_, value) {
                                console.log('getFieldValue', value, getFieldValue('chassis_number'), getFieldValue('engine_number'))
                ...
                <Col>
                    ...
                    <Radio.Group
                        ...
                        onChange={(e) => {
                            ...
                            loadDistricts(form.getFieldValue('owner_city'));
                            loadWards(form.getFieldValue('owner_district'));
                        }}
                        value={type}
                    >
...

                {
                    type == '1' && (
                        ...
                        <Col span={24}>
                            ...
                            <Button
                            type="link"
                            // className={`text-11 text-white mr-1 mt-1 ${currentName == -1 ? 'bg-primary' : 'bg-dark'}`}
                        ...
                        <Col xs={{ span: 24 }} md={{ span: 24 }}>
                            <Field type="text" required={true} name="full_name" title="Họ tên" desc="Họ và tên của bạn như trên Cà Vẹc xe" />
                        </Col>
                        {/* <Col xs={{ span: 24 }} md={{ span: 12 }}>
                        ...
                        <Col xs={{ span: 24 }} md={{ span: 12 }}>
                            <Field type="text" required={true} name="phone" title="Điện thoại" />
                        </Col>
                        <Col xs={{ span: 24 }} md={{ span: 12 }}>
                            <Field type="text" name="email" title="Email" desc="Email dùng để nhận giấy chứng nhận BH"
...

                {
                    ...
                    <>
                        <Col xs={{ span: 24 }} md={{ span: 24 }}>
                        <Field type="text" required={true} name="owner_name" title="Tên công ty / tổ chức" desc="Tên doanh nghiệp của bạn như trên Cà Vẹc xe" />
                        </Col>
                        <Col xs={{ span: 24 }} md={{ span: 24 }}>
                        <Field type="text" required={true} name="owner_address" title="Địa chỉ công ty / tổ chức" />
                        </Col>
                        <Col xs={{ span: 24 }} md={{ span: 8 }}>
                        <Field type="select" required={true} name="owner_city" groups={{ 'thanh-pho': 'Thành phố', 'tinh': 'Tỉnh' }} title="Tỉnh thành" datasource={cities} onChange={(value) => loadDistricts(value, true)} />
                        </Col>
                        <Col xs={{ span: 24 }} md={{ span: 8 }}>
                        <Field type="select" required={true} name="owner_district" title="Quận huyện" datasource={districts} onChange={(value) => loadWards(value, true)} />
                        </Col>
                        <Col xs={{ span: 24 }} md={{ span: 8 }}>
                        <Field type="select" required={true} name="owner_ward" title="Phường xã" datasource={wards} />
                        </Col>
                        ...
                        <Col span={24}>
                        <p className="ml-0 mb-0 text-11">Chọn người liên hệ (hoặc nhấn dấu + để thêm mới)</p>
                        {listName.map((item, index) => (
                            <Button key={index}
                            type="primary"
                        ...
                        <Button
                            type="link"
                            // className={`text-11 text-white mr-1 mt-1 ${currentName == -1 ? 'bg-primary' : 'bg-gray'}`}
                            className={`text-12 mr-1 mt-1`}
                            icon={<PlusOutlined />}
                            title="Thêm người mới"
                            onClick={() => onSelectUser(-1)}>
                        ...
                        {/* <Col xs={{ span: 24 }} md={{ span: 12 }}>
                        <Field type="select" required={true} name="sex" title="Danh xưng" datasource={[{ value: 0, label: 'Ông' }, { value: 1, label: 'Bà' }]} />
                        </Col> */}
                        <Col xs={{ span: 24 }} md={{ span: 12 }}>
                        <Field type="text" required={true} name="full_name" title="Họ tên" />
                        </Col>
                        <Col xs={{ span: 24 }} md={{ span: 12 }}>
                            <Field name="legal_id" type="text" title="CMND/CCCD/Hộ chiếu" />
                        </Col>
