...
import { submitDamage } from 'pages/api';
...
const DamageTest = ({ }) => {
    ...
    return (
        <>
            ...
            <div className="step-wrapper mt-5 mb-5" style={{ maxWidth: 1000, margin: '0px auto' }}>
                ...
                <div className="ezin-card-flat">
                    <Dragger {...props}>
                        ...
                        <p className="ant-upload-text">Nhấn hoặc kéo thả ảnh vào đây để upload</p>
                    ...
                    {result && (
                        <>
                            ...
                            >
                                ...
                                <div className="mt-5">
                                    <Button type="primary" htmlType="submit">Gửi kết quả</Button>
                                </div>
                            </Form>
                        </>
                    )}
