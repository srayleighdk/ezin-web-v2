...
export default function Complete() {
    return (<>
        <Head>
            ...
            <meta property="og:title" key="og-title" content={`Ghi nhận thành công | Ezin`} />
        </Head>
        <div className="step-wrapper mt-5" style={{ maxWidth: 1000, margin: '0px auto' }}>
                        ...
                        <div>
                            <div className="mt-1">
                                <Button type="primary" className="w-100">
                                    <Link href="/oto/physicaldamages/test">Thử với ảnh khác</Link>
                                </Button>
                            </div>
                            <div className="mt-1">
